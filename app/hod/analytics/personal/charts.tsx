...
export default function HODPersonalCharts({ rows }:{ rows: Array<{ label:string; total:number; research:number; university:number; community:number; teaching:number }> }){
